    ...
    <>
      <div className="bg-slate-500 h-screen p-3">
        ...
        >
            ...
            <h1 className="text-3xl text-center bg-slate-400">NexTalk</h1>
        ...
        <div className="w-full md:w-2/3 m-auto text-left rounded bg-gray-50 my-1 border-2 border-cyan-300">
